...
class Calculadora(object):
    ...
    def __init__(self):
        ...
        ttk.Button(mainframe, text='i', command=partial(self.ponerNUMERO, '11')).grid(column=3, row=8, sticky=W)
        ...
        ttk.Button(mainframe, text='C', command=partial(self.borrarItem)).grid(column=2, row=8, sticky=W)
        self.__panel.set('0')
        panelEntry.focus()
